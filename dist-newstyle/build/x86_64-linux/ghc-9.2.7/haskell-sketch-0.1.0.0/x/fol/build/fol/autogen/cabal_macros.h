...
#ifndef VERSION_haskell_sketch
#define VERSION_haskell_sketch "0.1.0.0"
#endif /* VERSION_haskell_sketch */
#ifndef MIN_VERSION_haskell_sketch
#define MIN_VERSION_haskell_sketch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_sketch */
...
#define CURRENT_COMPONENT_ID "haskell-0.1.0.0-inplace-fol"
